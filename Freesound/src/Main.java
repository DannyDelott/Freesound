...
public class Main {
	...
	public static void main(String[] args) throws IOException,
		...
		if (refreshToken == null || flagAccessToken) {
			...
			System.out
					.println("\nERROR: The refresh token is either missing or expired.  Please log in again with your Freesound username and password.\n");
	...
	private static void downloadSounds() {
		...
		// NOTE: set to false for the first sound
		boolean doNextSound = false;
